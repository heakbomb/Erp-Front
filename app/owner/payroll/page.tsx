...
const payrollHistory = [
  { month: "2024년 3월", totalPaid: 4850000, employees: 12, status: "지급완료" },
  { month: "2024년 2월", totalPaid: 4620000, employees: 12, status: "지급완료" },
  { month: "2024년 1월", totalPaid: 5120000, employees: 12, status: "지급완료" },
]
    ...
    <div className="space-y-6">
            ...
            <DialogContent>
              ...
              <div className="py-4">
                <p className="text-sm text-muted-foreground">
                  2024년 4월 근무 기록을 기반으로 {mockEmployeePayroll.length}명의 직원 급여를 계산하시겠습니까?
                </p>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockEmployeePayroll.length}명</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">2024년 최저시급: ₩9,860</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">4대보험 등 공제 비율</p>
              </div>
