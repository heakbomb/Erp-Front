// modules/dashboardC/OwnerDashboard.tsx
"use client";
...
import { useOwnerDashboard } from "./useDashboard";
import type { OwnerAlert, QuickAction, AiInsight } from "./dashboardTypes";

export default function OwnerDashboard() {
  const { stats, alerts, quickActions, aiInsights, loading, error } = useOwnerDashboard();

  if (loading && (!stats || stats.todaySales === undefined)) {
    return (
