  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">비활성 메뉴</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.inactive}개</div>
          </CardContent>
        </Card>
      </div>
          ...
          {loading ? (
            ...
            <>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {items.length === 0 ? (
                  <div className="text-sm text-muted-foreground col-span-full">데이터가 없습니다.</div>
                ) : (
                  items.map((item) => {
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    className="ml-2 h-9 rounded-md border px-2 text-sm bg-background"
                    value={pageSize}
                    onChange={(e) => {
